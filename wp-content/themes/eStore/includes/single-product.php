...
$et_affiliate =  isset($custom["affiliate_link"][0]) ? $custom["affiliate_link"][0] : '';
$et_mythumbnail =  isset($custom["my_thumbnail"][0]) ? $custom["my_thumbnail"][0] : '';
...
<?php if (!empty($custom["my_thumbnail"])) { ?>
	<div id="product-slider">
		<div id="product-slides">
			<?php for ($i = 0; $i <= count($custom["my_thumbnail"])-1; $i++) { ?>
				<div class="item-slide">
    <a href="<?php echo($custom["my_thumbnail"][$i]); ?>" class="fancybox">
		<?php echo et_new_thumb_resize( et_multisite_thumbnail($custom["my_thumbnail"][$i]), 298, 226 ); ?>
...
<div class="product-info">
	...
	<div class="clearfix">
		<?php if ($et_price <> '') { ?>
			...
			<a href="<?php echo($et_affiliate); ?>" target="_blank" class="addto-cart"><span>CHECK IT OUT</span></a>
		<?php }; ?>
	</div>
