...
<div class="categorydiv wp-auto-spinner-meta" id="taxonomy-category" style="<?php echo $display ?>">
	...
	<ul class="category-tabs" id="category-tabs">
		<li id="wp-auto-spin-rewritten-head" class="tab_head tabs"><a href="#">Rewritten Article</a></li>
		<li class="tab_head hide-if-no-js"><a href="#">Synonyms</a></li>
		<li class="tab_head hide-if-no-js"><a href="#">Original Article Before Rewriting</a></li>
	</ul>
...
jQuery('#spinner_dev   li').click(function(event){
    ...
    return false;
			...
			<div id="form-submit" class="field f_100   " style="padding:20px 0">
			    ...
			    <a  id="wordpress-auto-spinner-regenerate-re"  title="regenerate " class="button"  href="<?php echo site_url('/?wp_auto_spinner=ajax&action=rewrite'); ?>"> Generate new post</a>
	...
	<div class="tabs-panel  visible-overflow"   style="display: none;">
		...
		<div class="wp_signdev_form">
			...
			<div id="form-submit" class="field f_100   " style="padding:20px 0"> 
			    <a  id="wordpress-auto-spinner-regenerate"   title="Rewrite the post " class="button  " href="<?php echo site_url('/?wp_auto_spinner=ajax&action=rewrite'); ?>"> Generate new post from above synonyms </a>
